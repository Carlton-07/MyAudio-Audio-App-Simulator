		...
		while (scanner.hasNextLine())
		{
			try{
				...
				else if (action.equalsIgnoreCase("DOWNLOAD")) 
				{
					...
					for(int i=from_Index;i<=to_Index;i++){      //looping through the contents list
						AudioContent content = store.getContent(i);
						try{
								mylibrary.download(content); //downloading the content from that index
			...
			// see class Library for the method to call
				...
				else if(action.equalsIgnoreCase("SEARCH"))  //search the store for a title given by the user
				{
				...
				else if(action.equalsIgnoreCase("SEARCHA")) //search the store for the artist's name given by the user 
				{
				...
				else if(action.equalsIgnoreCase("SEARCHG")) //search the store for the genre given by the user
				{
				...
				else if(action.equalsIgnoreCase("DOWNLOADA")) //search the store for the artist's name given by the user
				{
				...
				else if(action.equalsIgnoreCase("DOWNLOADG")) //search the store for the genre given by the user
				{
				...
				else if(action.equalsIgnoreCase("SEARCHP")){ //search the store and every content in the store for a partial string given by the user
