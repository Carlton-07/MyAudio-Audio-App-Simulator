...
public class Song extends AudioContent implements Comparable<Song> // implement the Comparable interface
{
	...
	{
	  Song vibe = (Song)other; //jcompares two songs and returns true  if they are equal
	...
	{
		return this.getTitle().compareTo(other.getTitle()); //comparing songs based on title
